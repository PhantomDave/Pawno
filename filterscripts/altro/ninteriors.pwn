...
SA-MP Team (http://files.sa-mp.com/interiors.txt)
...
stock ShowInteriorDialog(playerid)
{
    ...
    return ShowPlayerDialog(playerid, DIALOG_INTERIOR_MENU, DIALOG_STYLE_LIST, "Interiors Disponibili", dialog_string, "Seleziona", "Cancella");
}
...
public OnFilterScriptInit()
{
    ...
    print(" nInteriors by Norn - CARICATO.");
    print("______________________________________");
    return 1;
}
...
{
    if (strcmp("/interiors", cmdtext, true, 10) == 0) {
    ...
    switch(dialogid) {
        case DIALOG_INTERIOR_MENU:
        {
            if(response) {
                ...
                format(string, sizeof(string), "[INTERIOR] Ti sei teletrasportato all'interior ' %s '.", InteriorDialogNames[arrayid][0]);
